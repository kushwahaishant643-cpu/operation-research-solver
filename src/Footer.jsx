    ...
    <footer className="or-footer">
      ...
      <div className="footer-main">
          ...
          <div className="footer-brand-title">
            <div className="footer-logo">
              ...
              >
                ...
                />
                <path
                  d="M5.5 8.2V13.5C5.5 15.2 8.4 17 12 17C15.6 17 18.5 15.2 18.5 13.5V8.2L12 10L5.5 8.2Z"
                  fill="white"
                />
                <path
                  d="M20 7V14"
                ...
                />
                <path
                  d="M20 14C18.8 14 18 14.8 18 16"
                  stroke="white"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                />
        ...
        <div className="footer-column">
          <div className="footer-heading">
            <span className="heading-icon">
              ...
              >
                ...
                />
                <path
                  d="M7.2 16.8L5.7 18.3C4.2 19.8 1.8 19.8 0.3 18.3C-1.2 16.8-1.2 14.4 0.3 12.9L4.5 8.7C6 7.2 8.4 7.2 9.9 8.7"
                ...
                />
                <path
                  d="M16.8 7.2L18.3 5.7C19.8 4.2 22.2 4.2 23.7 5.7C25.2 7.2 25.2 9.6 23.7 11.1L19.5 15.3C18 16.8 15.6 16.8 14.1 15.3"
                  transform="translate(-2 0)"
                  stroke="currentColor"
                  strokeWidth="1.8"
                  strokeLinecap="round"
          ...
          <div className="footer-links">
            ...
            <a href="#lpp" className="footer-link">
        ...
        <div className="footer-column">
          ...
          <div className="footer-links">
            <a href="#transportation" className="footer-link">
              <span>Transportation Problem</span>
              <span className="arrow">›</span>
            </a>

            <a href="#assignment" className="footer-link">
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-bottom-left">
          ...
          <span>2026 OR Smart Solver. All rights reserved.</span>
        </div>

        <div className="footer-bottom-right">
          <span>Built for B.Sc. IT</span>
      ...
      <style>{`
        ...
        .footer-accent-line {
          ...
          box-shadow:
            0 0 15px rgba(0, 201, 255, 0.45);
        }

        .footer-column {
          padding: 0 38px;
          border-left: 1px solid rgba(83, 137, 190, 0.32);
        }
        ...
        .circuit span {
          position: absolute;
          display: block;
          border-top: 2px solid rgba(0, 159, 255, 0.5);
          border-right: 2px solid rgba(0, 159, 255, 0.5);
        }
        ...
        @media (max-width: 700px) {
          ...
          .footer-connect {
            padding: 25px 0 0;
            border-left: none;
            border-top: 1px solid rgba(83, 137, 190, 0.32);
          }
